...
class Document {
  ...
  getTodosVerifying () {
    ...
    return this.getItems ( TodoVerifying, Consts.regexes.todoVerifying );

  }

  getTodoVerifyingAt ( lineNumber: number, checkValidity? ) {

    return this.getItemAt ( TodoVerifying, lineNumber, checkValidity );
